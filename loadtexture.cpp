...
LTexture::LTexture() //khởi tạo texture
{
	mTexture = nullptr;
...
LTexture::~LTexture() //giải phóng texture
{
	Free();
}
...
bool LTexture::LoadFromRenderedText(std::string textureText,TTF_Font *gFont, SDL_Color textColor, SDL_Renderer *gRenderer)//tải chữ lên màn hình
{
	Free();
